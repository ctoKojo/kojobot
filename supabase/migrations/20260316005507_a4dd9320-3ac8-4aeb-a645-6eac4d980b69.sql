...
-- Revert: academy_closure cancellations also use n+1 (matching unique index constraint)
-- But still don't increment owed_sessions_count for academy_closure
...
BEGIN
  ...
  -- Always use n+1 (unique index constraint requires it)
