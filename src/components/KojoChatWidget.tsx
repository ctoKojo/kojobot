    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 ltr:right-6 rtl:left-6 z-50 h-16 w-16 rounded-full shadow-lg overflow-hidden hover:scale-105 transition-transform animate-pulse pb-safe"
