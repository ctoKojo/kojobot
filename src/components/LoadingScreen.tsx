      ...
      <div className="text-center space-y-8">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 -m-4">
            <div
              className="w-32 h-32 mx-auto rounded-full border-4 border-transparent border-t-primary/60 border-r-primary/30 animate-spin"
          ...
          <div className="relative z-10 animate-bounce" style={{ animationDuration: "2s" }}>
            <div className="w-24 h-24 mx-auto rounded-2xl shadow-2xl shadow-primary/20 overflow-hidden bg-background flex items-center justify-center">
              <img
                src="/favicon.ico"
                alt="Kojobot"
                loading="eager"
        ...
        <div className="space-y-3 pt-4">
          <div className="relative overflow-hidden">
            <p className="text-lg font-medium text-foreground">{message || t.common.loading}</p>
